...
class Keywords {
  ...
  postData (data = {}) {
    return Utilities.executeCRUDRequest(this.apiServerUrl, this.apiKey, this.teamId, Enums.MODULE_KEY_KEYWORDS, Enums.METHOD_POST, data)
  }
  ...
  getData (profileKeys = [], recordIds = [], slimResult = true) {
    ...
    return Utilities.executeCRUDRequest(this.apiServerUrl, this.apiKey, this.teamId, Enums.MODULE_KEY_KEYWORDS, Enums.METHOD_GET, null, headers)
  }
  ...
  putData (recordId = '', data = {}) {
    ...
    return Utilities.executeCRUDRequest(this.apiServerUrl, this.apiKey, this.teamId, Enums.MODULE_KEY_KEYWORDS, Enums.METHOD_PUT, data, headers)
  }
  ...
  deleteData (recordId = '') {
    ...
    return Utilities.executeCRUDRequest(this.apiServerUrl, this.apiKey, this.teamId, Enums.MODULE_KEY_KEYWORDS, Enums.METHOD_DELETE, null, headers)
  }
