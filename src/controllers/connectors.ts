...
class Connectors {
  ...
  putData (recordId: string = '', data: any = {}, resetService: boolean = false, logProfileKey: string = '') {
    let headers: any = {}
  ...
  execute (profileKey: string = '', routeKey: string = '', data: any = {}, isResponseFile: boolean = false, logProfileKey: string = '') {
